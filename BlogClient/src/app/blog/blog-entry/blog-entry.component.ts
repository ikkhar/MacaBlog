...
export class BlogEntryComponent implements OnInit {
  ...
  blogParagraph = '<strong>Est</strong> la description du blog n°0 Sed ut ' +
    ...
    'omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem <pre class="codeExemple">\n' +
    '  <code>\n' +
    '    p { color: red; }\n' +
    '    body { background-color: #eee; }\n' +
    '  </code>\n' +
